...
<div class="miniSousMenu padV10">
    ...
    <div class="inline top leftText">
        <div class="sousMenuBtns hide" id="tekosMenuBtns">
            ...
            <a class="bouton miniSmenuBtn" id="personnel_add_techniciens" <?= $hideForPoppy; ?> href="#">Ajout</a>
        </div>
    </div>

    <div class="sousMenuIcon inline bouton big marge30l usersMiniSsMenu" <?= $hideForUser ?> title="UTILISATEURS">
    ...
    <div class="inline top rightText">
        <div class="sousMenuBtns hide" id="usersMenuBtns">
            ...
            <a class="bouton miniSmenuBtn" id="personnel_add_utilisateurs" <?= $hideForPoppy ?> href="#">Ajout</a>
        </div>
    </div>
...
<div id="personnelPage" class="pageContent">
    ...
    if (isset($_GET['sousPage'])) {
        ...
        $goto = 'personnel_list_techniciens.php';
    }
