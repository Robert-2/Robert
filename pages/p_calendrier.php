...
<div id="friseLegende" class="leftText mini">
    <div class="center">
        <span class="ui-widget ui-state-default ui-corner-all marge10l padH5 padV10"
              style="color:#888888; font-weight: bold;">GRIS = évènements passés
        </span>
        <span class="ui-widget ui-state-default ui-corner-all marge10l padH5 padV10"
              style="color:#c24141; font-weight: bold;">ROUGE = évènements en cours !
        </span>
...
<div id="dialogContrat" title="Édition du contrat" class="hide">
    ...
    <textarea id="contratText" rows="20" cols="100">
        <?php include('contrat_location.php'); ?>
    </textarea>
</div>
