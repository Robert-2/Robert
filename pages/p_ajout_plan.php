...
$refreshEtape1 = '';
 ...
 // Si des GET de dates sont définies, on écrase le plan en session
...
// Sinon, on rappelle les valeurs du plan en session (si défini)
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        <?= (isset($recupStart)) ? "$('#picker_start').datepicker('setDate', '$recupStart');\n" : ''; ?>
        <?= (isset($recupEnd)) ? "$('#picker_end').datepicker('setDate', '$recupEnd');\n" : ''; ?>
        <?= $refreshEtape1; ?>
        <?php
...
<div class="miniSousMenu gros" style="padding: 5px 10px 10px 10px;">
    ...
    <div class="inline demi center">
        <div class="inline ui-state-highlight ui-corner-all pad5 gros" id="rappelPlanInfos">
            Création de <i><b id="rappelTitrePlan"></b></i>	à
            <b id="rappelLieuPlan"></b>, pour <b id="rappelBenefPlan"></b>
        </div>
    </div>
    <div class="inline quart rightText">
        <button class="bouton prevEtape" onclick="prevEtape()">
            <span class="inline ui-icon ui-icon-arrowthick-1-w"></span>Précédent
        </button>
        <button class="bouton nextEtape" onclick="nextEtape()">
            <span class="inline ui-icon ui-icon-arrowthick-1-e"></span>Suivant
        </button>
    </div>
</div>
...
<div class="addSection ui-widget-content ui-corner-all center pad20 hide" id="etape-4">
    ...
    <div id="recapPlan" class="gros pad10 ui-corner-all leftText shadowIn"></div>
    <br /><br />
