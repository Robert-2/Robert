...
CREATE TABLE `robert_benef_interlocuteurs` (
  ...
  `remarque` text NULL,
  `nomStruct` varchar(64) NULL,
  `typeRetour` varchar(64) NULL,
  PRIMARY KEY (`id`),
  KEY `label` (`label`),
...
CREATE TABLE `robert_benef_structure` (
  ...
  `interlocteurs` varchar(256) NULL,
  `adresse` varchar(128) NOT NULL,
  `codePostal` varchar(8) NOT NULL,
  `ville` varchar(64) NOT NULL,
  `email` varchar(64) NULL,
  `tel` varchar(14) NULL,
  `listePlans` varchar(512) NULL,
  `decla` varchar(256) NULL,
  `remarque` text NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `robert_plans_details` (
  ...
  `materiel` text NOT NULL,
  `details_remarque` mediumtext NULL,
...
CREATE TABLE `robert_tekos` (
  ...
  `email` varchar(128) NULL,
  `tel` varchar(20) NULL,
  `GUSO` varchar(128) NULL,
  `CS` varchar(128) NULL,
  `birthDay` date NULL,
  `birthPlace` varchar(256) NULL,
  `habilitations` varchar(256) NULL,
  `categorie` varchar(128) NULL,
  `SECU` varchar(128) NULL,
  `SIRET` varchar(128) NULL,
  `assedic` varchar(64) NULL,
  `intermittent` tinyint(1) NULL,
...
CREATE TABLE `robert_users` (
  ...
  `date_last_action` int(10) NULL,
  `date_last_connexion` int(10) NULL,
  `theme` varchar(32) NULL,
  `idTekos` smallint(3) NULL,
  PRIMARY KEY (`id`),
